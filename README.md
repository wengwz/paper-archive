...
- [CSTIC 2025](https://www.semiconchina.org/en/5): "Accelerating the Physical Design of Large FPGAs through Divide-and-Conquer Methodology" \[[PDF](./pre-built/CSTIC2025_final.pdf)\]

- "RapidPnR: Accelerating the Physical Design for FPGAs via Design-Level Parallelism" \[[PDF](./pre-built/RapidPnR.pdf)\]